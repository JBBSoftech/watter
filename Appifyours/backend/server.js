...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/watter_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '695b5a25b24bc8867b77f3df',
      shopName: 'watter',
...
app.listen(PORT, () => {
  console.log(`watter Backend Server running on port ${PORT}`);
});
